...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2406041063560069565L;
   ...
   */
  public static com.test.kafka.model.Product.Builder newBuilder() {
    return new com.test.kafka.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.test.kafka.model.Product.Builder newBuilder(com.test.kafka.model.Product.Builder other) {
    if (other == null) {
      return new com.test.kafka.model.Product.Builder();
    } else {
      return new com.test.kafka.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.test.kafka.model.Product.Builder newBuilder(com.test.kafka.model.Product other) {
    if (other == null) {
      return new com.test.kafka.model.Product.Builder();
    } else {
      return new com.test.kafka.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.test.kafka.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.test.kafka.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.Color)) {
        this.Color = data().deepCopy(fields()[0].schema(), other.Color);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder setColor(com.test.kafka.model.Color value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder clearColor() {
      Color = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder setProductType(com.test.kafka.model.ProductType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder clearProductType() {
      ProductType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder setDesignType(com.test.kafka.model.DesignType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.model.Product.Builder clearDesignType() {
      DesignType = null;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.Color = com.test.kafka.model.Color.values()[in.readEnum()];

      this.ProductType = com.test.kafka.model.ProductType.values()[in.readEnum()];

      this.DesignType = com.test.kafka.model.DesignType.values()[in.readEnum()];
