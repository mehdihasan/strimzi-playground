...
public class Main {
    ...
    private static final String DEFAULT_INPUT_TOPIC = "streams-transformation-test-input-topic-v0";
    private static final String DEFAULT_OUTPUT_TOPIC = "streams-transformation-test-output-topic-v0";
    ...
    public Properties createProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "demo-streams-processor-avro");
